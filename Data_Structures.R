...
as.numeric(TRUE) # 1
as.numeric(FALSE) # 0
as.character(4) # FALSE
as.numeric("4.5") # FALSE
as.numeric("Hello") # FALSE
...
f_vector <- factor(c('first','second','third','first','third','second'), levels = c('first','second','third'),
                   ordered = TRUE)
print(f_vector)
print(max(f_vector))
